...
[center, pos_vector, n] = my_kmean(data_shuffled(1:4, :), num_tr, num_hd, data_Kmean_50(1:4,:));
...
o_Kmean_50_True(o_Kmean_50<0) = -1;
o_Kmean_50_True(o_Kmean_50_True~=-1) = 1;
...
for i=1:length(Test_Data)
    ...
    o_Kmean_50_test(i) = w_50*g;
end

% o_Kmean_50_True_Test(o_Kmean_50<0) = -1;
% o_Kmean_50_True_Test(o_Kmean_50_True_Test~=-1) = 1;
%%
%
nanmap=isnan(o_Kmean_50_test);
o_Kmean_50_True_Test(o_Kmean_50_test<0) = -1;
o_Kmean_50_True_Test(o_Kmean_50_test>=0) = 1;
o_Kmean_50_True_Test(nanmap)=nan;
%%
% B = reshape(o_Kmean_100_True_Test, 361, 320);

B = reshape(o_Kmean_50_True_Test, [], 361);
B = B';
